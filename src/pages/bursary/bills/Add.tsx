    ...
    <BursaryLayout>
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Add New Bill</h1>
            <p className="text-muted-foreground mt-1">Create a new fee bill</p>
          </div>
        </div>
        ...
        {mutation.error && (
          <Alert variant="destructive">
            <AlertDescription>
              Failed to create bill. Please check your inputs and try again.
            </AlertDescription>
          </Alert>
        )}
      </div>
